                ...
                <div className="col-lg-3 col-sm-6 col-12 section-space--bottom--30" key={i}>
                    <div className="team">
                        ...
                        <div className="social">
                            <a href={val.socialLinks.facebook} className="facebook"><i className="zmdi zmdi-facebook" /></a>
                            <a href={val.socialLinks.twitter} className="twitter"><i className="zmdi zmdi-twitter" /></a>
                            <a href={val.socialLinks.linkedin} className="linkedin"><i className="zmdi zmdi-linkedin-box" /></a>
                            <a href={val.socialLinks.googlePlus} className="google"><i className="zmdi zmdi-google-plus" /></a>
                        </div>
                        </div>
                    </div>
                </div>
