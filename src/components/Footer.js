                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="row">
                                ...
                                <div className="footer-widget mb-0">
                                    ...
                                    <p className="address">Office # 03, Ground Floor Equity RealEstate, Plaza # 82 Lane 1 Bahria Square Commercial, Phase 7, RWP.</p>
                                    <ul className="contact-details">
                                        <li><span>P:</span>+92 333 539 9620</li>
                                        <li><span>F:</span>+92 335 222 1946</li>
                                        <li><span>E:</span>Equityinfoonline@gmail.com</li>
                                    </ul>
                                    </div>
                                </div>
                                </div>
