                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="header-info-wrapper align-items-center">
                                    ...
                                    <div className="header-info-single-item">
                                        ...
                                        <p className="header-info-single-item__subtitle">+92 333 539 9620</p>
                                        </div>
                                    </div>
                                    <div className="header-info-single-item">
                                        <div className="header-info-single-item__icon">
                                        ...
                                        <p className="header-info-single-item__subtitle" style={{width: '24rem'}}>Office # 03, Ground Floor Equity RealEstate, Plaza # 82 Lane 1 Bahria Square Commercial, Phase 7, RWP</p>
                                        </div>
                                    </div>
                                    </div>
                                    {/* mobile menu */}
